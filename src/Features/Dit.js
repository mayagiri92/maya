...
const Dit = () => {
  return (
    <div>
      <div className='bg-gray-50 mt-6 underline text-center font-semibold p-4 '>About of Information Technology</div>
...
<img src={nflag} alt='' className='rounded-xl mt-20 h-64 ml-28 w-64' />
       ...
       <div className='rounded-xl  w-[980px] h-[500px] ml-80 p-5 mr-28'>
        <h1 className='  font-semibold underline mt-4 '> Information Technology</h1>
        <h2 className='mt-4 '>Dear Student and Parents,</h2>
...
<div className='bg-orange-50 rounded-xl h-14 w-56'>
      ...
      <h2 className='text-center'>IT Co-odinator</h2>
        ...
        <div className='rounded-xl bg-gray-50  ml-56 w-[800px] h-[500px] text-justify p-5 '> <h1 className='  font-semibold underline  '>Message From IT Co-ordinator</h1>
